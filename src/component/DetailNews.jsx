...
import { faCalendarAlt, faLeftLong, faMapMarkerAlt, faTag } from "@fortawesome/free-solid-svg-icons";
import { HashLink } from "react-router-hash-link";

export default function DetailNews(props) {
    const { newsCategory, newsDate, newsImg, newsLocation, newsLongDesc, newsTitle } = props;
    ...
    return (
            ...
            <div className="w-11/12 md:w-9/12 mx-auto mt-10 flex flex-col py-8 mb-16">
                <div className="bg-white shadow-2xl rounded-lg overflow-hidden">
                    <img src={newsImg} alt={newsTitle} className="w-full h-48 md:h-96 object-cover" />
                    <div className="p-6 md:p-20">
                        <h1 className="text-2xl md:text-4xl font-bold text-gray-800 mb-4">{newsTitle}</h1>
                        ...
                        <p className="text-gray-700 leading-relaxed mb-6 whitespace-pre-line text-justify">{newsLongDesc}</p>

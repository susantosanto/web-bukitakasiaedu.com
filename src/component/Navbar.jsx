...
const Navbar = () => {
  ...
  return (
    <div
      className={`z-10 top-0 bg-transparent sticky transition-all duration-300 w-full ${
        isScrolled ? "" : ""
      }`}
    >
      <div
      ...
      >
        <div className="w-full lg:w-8/12 mx-auto h-12 flex items-center justify-between">
          {isScrolled && (
          ...
          >
            ...
            >
              <img
                src={logo}
                alt="logo"
                className={`${isScrolled ? "w-12 h-12" : "w-44 mt-3"}`}
              />
            </div>
          </div>

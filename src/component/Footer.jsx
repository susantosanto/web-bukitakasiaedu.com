            ...
            <div className="container w-11/12 md:w-9/12 mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className='hidden lg:block'>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><a href="#" className="hover:text-gray-300">Akademik</a></li>
                            <li><a href="#" className="hover:text-gray-300">Komunitas</a></li>
                            <li><a href="#" className="hover:text-gray-300">Fasilitas</a></li>
                ...
                <div className="mt-8 flex flex-col md:flex-row justify-between items-center">
                    <div className="flex space-x-6 mb-4 md:mb-0">
                        <a href="bukitakasiaoffice@gmail.com" className="text-white hover:text-gray-300 transition-colors duration-500">
                            <FontAwesomeIcon icon={faEnvelope} size="2x" />
                        </a>
                        <a href="tel:1234567890" className="text-white hover:text-gray-300 transition-colors duration-500">
                            <FontAwesomeIcon icon={faPhone} size="2x" />
                        </a>
                        <a href="https://web.facebook.com/p/Sekolah-Alam-Bukit-Akasia-100078924381045/" className="text-white hover:text-gray-300 transition-colors duration-500">
                            <FontAwesomeIcon icon={faFacebook} size="2x" />
                        </a>
                        <a href="#" className="text-white hover:text-gray-300 transition-colors duration-500">
                            <FontAwesomeIcon icon={faTwitter} size="2x" />
                        </a>
                        <a href="https://www.instagram.com/akasia_edu/?hl=id" className="text-white hover:text-gray-300 transition-colors duration-500">
                            <FontAwesomeIcon icon={faInstagram} size="2x" />
                        </a>
                        <a href="https://www.youtube.com/channel/UC-LzMpLzWE7oluhkmCoD-Vg" className="text-white hover:text-gray-200 transition-colors duration-500">
                            <FontAwesomeIcon icon={faYoutube} size="2x" />
                        </a>
                    </div>
                    <div className="text-center md:text-right">
                        <p>&copy; {new Date().getFullYear()} Yayasan Bukit Akasia. All rights reserved.</p>
                    </div>
                </div>
            </div>
        </footer>

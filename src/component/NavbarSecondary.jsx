...
import { faSearch, faPhone, faEnvelope, faMapMarkerAlt, faBars, faTimes, faChevronUp, faChevronDown } from "@fortawesome/free-solid-svg-icons";
        ...
        <div className={`z-10 top-0 bg-white sticky transition-all duration-300`}>
            ...
            <div className={`py-1 bg-primary`}>
                <div className="lg:w-9/12 w-full mx-auto h-12 flex items-center">
                    ...
                    <div className={`w-3/12 flex items-center mx-auto transition-all duration-300 mt-0`}>
                        <div className={`w-52 h-52 rounded-full justify-center flex items-center transition-all duration-300 `}>
                            <img src={logo} alt="logo" className={`w-12 h-12`} />
                        </div>
                    </div>

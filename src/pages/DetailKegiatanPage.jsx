        ...
        <div className="w-full">
            ...
            <div className="w-9/12 mx-auto mt-10 flex flex-col py-8 mb-16">
                <div className="bg-white shadow-2xl rounded-lg overflow-hidden">
                    <img src={kegiatan.imgSrc} alt={kegiatan.title} className="w-full h-96 object-cover" />
                    <div className="p-20">
                        <h1 className="text-4xl font-bold text-gray-800 mb-4">{kegiatan.title}</h1>
                        ...
                        <p className="text-gray-700 leading-relaxed mb-6 whitespace-pre-wrap text-justify">{kegiatan.longDesc}</p>
                        <p className="text-slate-500 mt-4 text-right"><HashLink smooth to={`/kegiatan-page#kegiatan`} className="text-orange"><FontAwesomeIcon icon={faLeftLong} className="text-orange-500" /> Kembali</HashLink></p>

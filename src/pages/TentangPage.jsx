...
import { faLeaf, faHandsHelping, faAngleRight } from '@fortawesome/free-solid-svg-icons';
        ...
        <div id="tentangSekolah" className="w-full">
            ...
            <div className="w-9/12 mx-auto mt-20">
                <div className="flex flex-col space-y-4 mb-10">
                    <h1 className="text-slate-700 text-4xl">SD Alam Bukit Akasia</h1>
                ...
                <div className="flex space-x-10">
                    <div className="basis-1/2 text-slate-500 text-justify flex flex-col space-y-5">

                        <p>Setiap anak cerdas pada bidangnya. Menjadi tantangan orangtua agar sejak dini menemukan keunggulan putra-putrinya. SD Alam Bukit Akasia menerapkan metode montessori Kapal Pecah (Kapsul Alur Permainan Bocah) yang menerapkan pemahaman kecerdasan majemuk pada setiap pelaksanaan kegiatan belajar.
                        </p>
                        <p>Tidak ada siswa yang tak pintar. Sebab mereka akan menjadi bintang di empat Kapsul (kelas tematik) yang mereka ikuti, setiap hari.
                        </p>
                        <p>Kapsul yang penuh keseruan dan menantang itu adalah, Kapsul Ilmuwan, Kapsul Seniman,
                            Kapsul Pencerita, dan Kapsul Teknokrat.
                        </p>
                        <p>Mengeksplorasi. kawasan Bukit Akasia seluas 5 hektare, meliputi peternakan, perkebunan,
                            Bazar Gantoeng, Camping Ground, SD Alam Bukit Akasia akan memberikan pengalaman belajar yang penuh petualangan, aman, dan mencerdaskan.
                        </p>
                        <p className="">SD Alam Bukit Akasia tetap menerapkan Kurikulum Nasional namun menyampaikannya
                            dengan metode khas Bukit Akasia. Kami menggabungkan pemahaman kecerdasan majemuk, metode montessori, dan pembelajaran berbasis alam.
                        </p>

                    </div>
                    <div className="basis-1/2 flex flex-col">
                        <div className="w-full h-1/2 p-3 overflow-hidden shadow-xl transform transition duration-500 hover:scale-105 hover:shadow-2xl">
                            <img src={imgTentang} className="object-cover w-full h-full lazyload" alt="" />
                        </div>
                        <div className=" mt-8 text-slate-100 mx-auto transform transition duration-500 hover:scale-105 hover:shadow-2xl">
                            <HashLink smooth to='/fasilitas-page#fasilitas' href="#" className=" py-3 px-4 p-2 text-sm bg-primary rounded-full  font-bold shadow-lg">Jelajahi Fasilitas di SD Alam Bukit Akasia<FontAwesomeIcon icon={faAngleRight} className="ml-3" /></HashLink>
                        </div>
                    </div>
                </div>
            ...
            {/* Section Kurikulum */}
            <div id="kurikulum" className="-mt-64 py-14">
                <div className="w-9/12 mx-auto">
                    <div className="mb-8 border-b border-orange">
                        <h2 className="text-3xl text-slate-800 pb-8">Kurikulum Kami</h2>
                    </div>

                    <div className="flex flex-col md:flex-row items-center md:space-x-10 mb-16">
                    ...
                    <div className="flex">
                        ...
                        <div className="basis-1/2 overflow-hidden">
                            <div className="whitespace-nowrap transition duration-200" style={{ transform: `translateX(-${activeSlide * 100}%)` }}>
                                {DataMetodePembelajaran.map((slide, index) => (
                                    <div key={index} className="inline-block w-full p-3">
            ...
            {/* Section Visi Misi */}
            <div id="visi" className="p-10 -mt-36 min-h-screen flex items-center justify-center bg-white">
                <div className="w-full max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10">
                    <div className="flex flex-col items-center bg-white shadow-md rounded-lg p-6 transform transition duration-500 hover:scale-105 hover:shadow-lg h-96">
                        <FontAwesomeIcon icon={faLeaf} className="text-5xl text-primary mb-4 animate-bounce" />
                    ...
                    <div className={`relative flex flex-col items-center bg-white shadow-md rounded-lg p-6 transform transition duration-500 hover:scale-105 hover:shadow-lg ${showMore ? 'h-auto' : 'h-96'} overflow-hidden`}>
                        <FontAwesomeIcon icon={faHandsHelping} className="text-5xl text-primary mb-4 animate-bounce" />
            ...
            <div id="strukturOrganisasi" className="w-9/12 mx-auto -mt-20">

                <div className="flex items-center space-x-10 h-96">
                    <div className=" text-slate-500 text-justify flex flex-col space-y-3">
                        <h1 className="text-3xl text-slate-700 mb-5 pb-8 border-b border-orange">Struktur Organisasi</h1>
                        ...
                        <p>
                            Mereka bekerja sama untuk memastikan bahwa setiap siswa SD Alam Bukit Akasia mendapatkan pendidikan yang berkualitas tinggi, memuaskan, konsisten, dan sesuai.
                        </p>
                    </div>
                </div>
                <div id="prakata" className="">
                    <div className="flex space-x-4 mb-16">
                        <button className={`py-2 px-4 rounded-full transform transition duration-500 hover:scale-105 cursor-pointer ${selectedSection === "pengurus-yayasan" ? "bg-primary text-white" : "bg-gray-300 text-gray-700"}`} onClick={() => setSelectedSection('pengurus-yayasan')}>Pengurus Yayasan</button>
                        <button className={`py-2 px-4 rounded-full transform transition duration-500 hover:scale-105 cursor-pointer ${selectedSection === "prakata-sekolah" ? "bg-primary text-white" : "bg-gray-300 text-gray-700"}`} onClick={() => setSelectedSection('prakata-sekolah')}>Prakata Kepala Sekolah</button>
                        <button className={`py-2 px-4 rounded-full transform transition duration-500 hover:scale-105 cursor-pointer ${selectedSection === "tim-pendidik" ? "bg-primary text-white" : "bg-gray-300 text-gray-700"}`} onClick={() => setSelectedSection('tim-pendidik')}>Tim Pendidik</button>
                    </div>
                    {selectedSection === "pengurus-yayasan" && (
                        <div id="pengurus-yayasan" className="bg-white p-10 shadow-lg rounded-lg">
                            <h2 className="text-3xl font-bold text-slate-700 mb-7">Pengurus Yayasan</h2>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                {DataPengurus.map((pengurus, index) => (
                                    <div
                                        key={index}
                                        className="bg-white w-80 rounded-lg shadow-lg overflow-hidden transform transition duration-500 hover:scale-105 cursor-pointer"
                                    >
                                        <div className="relative w-full h-80 overflow-hidden"> {/* Sesuaikan tinggi sesuai kebutuhan */}
                                        ...
                                        <div className="p-3">
                                            <div className="">
                                                ...
                                                <p className="mt-4 text-sm text-gray-600">{pengurus.bio}</p>
                                            </div>
                                        </div>
                                    </div>
                                ))}
                    ...
                    {selectedSection === "prakata-sekolah" && (
                        <div id="prakata-sekolah" className="bg-white p-10 flex flex-col shadow-lg rounded-lg mb-16">
                            <div className="flex items-center space-x-7">
                                <div className="basis-1/2 text-justify">
                                    <h2 className="text-3xl font-bold text-slate-700 mb-10">Prakata Sekolah</h2>
                                ...
                                <div className="basis-1/2">
                                    <div className="p-3 overflow-hidden shadow-xl">
                                        <img src={fotoks} className="object-cover w-full h-full object-top" alt="" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    {selectedSection === "tim-pendidik" && (
                        <div id="tim-pendidik" className="bg-white p-10 shadow-lg rounded-lg">
                            <h2 className="text-3xl font-bold text-slate-700 mb-7">Tim Pendidik</h2>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                    ...
                                    >
                                        ...
                                        <div className="p-3">
                                            <div className="">
                                                ...
                                                <p className="mt-4 text-sm text-gray-600">{guru.bio}</p>
                                            </div>
                                        </div>
                                    </div>
                                ))}
